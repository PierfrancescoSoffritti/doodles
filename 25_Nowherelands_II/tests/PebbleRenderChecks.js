...
import { FaunaModel } from '../js/world/fauna/FaunaModel.js?v=pebble-expression-2';
import { PebbleMeshes } from '../js/world/fauna/PebbleMeshes.js?v=pebble-expression-2';
