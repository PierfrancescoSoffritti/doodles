...
export class Wind extends Layer {
	...
	update(dt, p) {
		...
		this.noise.filter.frequency.setTargetAtTime(this.cutoff, this.engine.now, 0.3);
		...
		const wanted = 0.02 + p.snow * (0.025 + 0.045 * swell) + p.speed * 0.05 + p.altitude * 0.04 + p.turn * 0.16 + p.wading * 0.12;
