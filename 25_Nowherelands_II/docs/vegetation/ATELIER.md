...
Click/tap the canvas, press **N**, or choose **Offer a note**. Hold N or a stationary canvas press for a stronger invitation; the dedicated stronger-note button gives the same maximum charge. A fresh tap gets a leading answer in 45 ms, followed by one or two quieter neighbors. Rapid taps hand the lead to recently quiet flowers and retain answers already travelling through the patch. The reply spacing follows the player's recent tapping interval. A charged note makes every flower in the family answer together, with a shared light and motion onset and a bounded chord. Click a specific husk to make it lead. Following replies vary across the family and favor flowers that have sounded less often, independent of distance. Each bulb lights and its flower nods with a gentle rebound on its own sounding note, then settles back to white. Rapid clicks add motion without resetting the pose. Smaller flowers have higher, shorter voices and quicker light envelopes. Uncharged phrases remain capped at eight; charged replies schedule exactly one response per flower; older audio tails fade out when needed to make room.
